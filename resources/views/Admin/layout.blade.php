            ...
            <div class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="{{ url('/') }}"><i class="fa fa-dashboard fa-fw"></i> Home page</a>
                        </li>                        
                        <li>
                            <a href="{{ url('backend/category') }}"><i class="fa fa-table fa-fw"></i> Categories</a>
                        </li>
                        <li>
                            <a href="{{ url('backend/products') }}"><i class="fa fa-edit fa-fw"></i>Products</a>
                        </li>
                        <li>
                            <a href="{{ url('backend/color') }}"><i class="fa fa-edit fa-fw"></i> Color</a>
                        </li>
                        <!-- <li>
                        ...
                        <li>
                            <a href="{{ url('backend/size') }}"><i class="fa fa-edit fa-fw"></i> Size</a>
                        </li>
                        <li>
